...
export class PaymentManagerService implements IPaymentManagerService {
  private _repository: IPaymentManagerRepository;
  ...
  async addTransaction(DTO: TTransactionDTO): Promise<string | undefined> {
    return await this._repository.insertPaymentHistory(DTO);
  }
