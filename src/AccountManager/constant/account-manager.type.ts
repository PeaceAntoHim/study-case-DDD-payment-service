...
export type TInsertToken = { hashedToken: string; refreshToken: string; id: string; userId: number };
...
export type TSigninResDb = { id: number; email: string; role: string; refreshToken?: string; hashedToken?: string };
